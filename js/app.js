document.addEventListener('DOMContentLoaded', () => {
    ...
    const sendMessage = async () => {
        ...
        try {
            // Aseguramos que estamos utilizando POST y apuntando al servidor correcto
            const response = await fetch('http://194.164.165.103:3001/query', {  // URL correcta del serverLang.py
                method: 'POST',
                headers: {
